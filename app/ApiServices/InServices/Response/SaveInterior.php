...
class SaveInterior extends BaseResponse implements InterfaceResponse
{
    /**
     * 接口名称
     *
    ...
    public function run(&$params)
    {
        ...
        if(empty($merchant_info)){
            MerchantInfo::create(['user_id'=>$params['id'],'interior_picture'=>$contract_tenancy]);
        }else{
            $merchant_info->interior_picture = $contract_tenancy;
            $merchant_info->save();
        }
