 ...
 * api测试类
 */
class StoreLogin extends BaseResponse implements InterfaceResponse
{
    /**
     * 接口名称 kui
     * @var string
    ...
    public function run(&$params)
    {
        ...
        $err_1 = ['status' => false, 'code' => '00010001', 'msg' => '手机号或密码错误,或身份不是门店'];
