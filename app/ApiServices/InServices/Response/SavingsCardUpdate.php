...
//银行卡添加
//谢树文
class SavingsCardUpdate extends BaseResponse implements InterfaceResponse
{
    /**
     * 接口名称
     * @var string
    ...
    public function run(&$params){
       ...
       $data = DB::table('user_savings_cards')->where('user_savings_cards.user_id','=',$params['id'])->insert($row);
