...
class StoreSettleLogController extends Controller
{
    public function index()
    {
        ...
        return _view('merchant.store_settle_log.index', compact('data'));
    }
    ...
    public function detail($id)
    {
        ...
        return _view('merchant.store_settle_log.detail', compact('settleLog', 'orders'));
    }
    ...
    public function subOrders(SettleLog $settleLog){
        ...
        return _view('merchant.store_settle_log.sub_orders', compact('orders'));
    }
}
