...
class SettleLogController extends Controller
{
    public function index()
    {
        ...
        return _view('agent.settle_log.index', compact('data'));
    }
    ...
    public function detail($id)
    {
        ...
        return _view('agent.settle_log.detail', compact('settleLog', 'orders'));
    }
    ...
    public function subOrders(SettleLog $settleLog){
        ...
        return _view('agent.settle_log.sub_orders', compact('orders'));
    }
