...
@section('content')
    <div class="box">
        <div class="box-body">
            <a class="pretty-btn" href="{{ route('merchant.merchant.create') }}">添加子代理</a>
        </div>
            ...
            <div class="modal fade" id="modal-user-add" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('merchant.merchant.store') }}">
            ...
            <table class="table table-bordered text-center table-hover table-responsive">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>@if($item->isCheckedMerchant())代理已审核@else<span class="text-danger">代理未审核</span>@endif</td>
                        <td>{{ $item->created_at }}</td>
                        <td>
                            <a class="pretty-btn" href="{{route('merchant.merchant.show', ['agent' => $item->id])}}">详情</a>
                            <a class="pretty-btn" href="{{route('merchant.merchant.edit', ['agent' => $item->id])}}">修改</a>
