        ...
        <div>
            ...
            <div class="tab-content">
                <div class="tab-pane active row margin-0" id="home">
                        ...
                        <div class="overview-panel-inner card">
                            ...
                            <div class="overview-panel-body">
                                ...
                                <ul class="overview-task-list">
                                    <li>
                                        <div class="overview-task-inner">
                                            <span class="overview-task-title">成员总数</span>
                                            <span class="overview-task-num">{{ $data['total_member'] }}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xs-12 col-lg-3 overview-task overview-panel">
                        <div class="overview-panel-inner card">
                            <div class="overview-panel-title">我的商户</div>
                            <div class="overview-panel-body">
                                <ul class="overview-task-list">
                                    <li>
                    ...
                    <div class="col-xs-12 col-lg-3 overview-task overview-panel">
                        <div class="overview-panel-inner card">
                            <div class="overview-panel-title">我的子代理</div>
                            <div class="overview-panel-body">
                                <ul class="overview-task-list">
                                    <li>
                                        <a href="{{ route('agent.agent.index', $whereToday) }}" class="overview-task-inner">
                                            <span class="overview-task-title">今日新增</span>
                                            <span class="overview-task-num">{{ $data['today_agent'] }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="overview-task-inner">
                                            <span class="overview-task-title">今日已审核</span>
                                            <span class="overview-task-num">{{ $data['today_checked_agent'] }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('agent.agent.index') }}" class="overview-task-inner">
                                            <span class="overview-task-title">总数</span>
                                            <span class="overview-task-num">{{ $data['total_agent'] }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="" class="overview-task-inner">
                                            <span class="overview-task-title">已审核</span>
                                            <span class="overview-task-num">{{ $data['total_checked_agent'] }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
