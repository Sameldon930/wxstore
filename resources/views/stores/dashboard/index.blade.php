    ...
    <div class="box">
        ...
        <div>
            ...
            <ul class="nav nav-pills">
                <li><a href="#profile" data-toggle="tab">我的订单</a></li>
                ...
                <div class="tab-pane active"  id="profile">
                    <div class="col-xs-12 col-lg-3 overview-task overview-panel">
                        <div class="overview-panel-inner card">
                            <div class="overview-panel-title">今日订单</div>
                            <div class="overview-panel-body">
                                <ul class="overview-task-list">
                                    <li>
                                        <a href="{{ route('stores.order.index', $whereToday) }}" class="overview-task-inner">
                                    ...
                                    <li>
                                        <a href="{{ route('stores.order.index', $whereToday+['pay_status' => \App\Order::PAY_STATUS_PAID]) }}" class="overview-task-inner">
                                            <span class="overview-task-title">已支付</span>
                    ...
                    <div class="col-xs-12 col-lg-3 overview-task overview-panel">
                        <div class="overview-panel-inner card">
                            <div class="overview-panel-title">当月订单</div>
                            <div class="overview-panel-body">
                                <ul class="overview-task-list">
                                    <li>
                                        <a href="{{ route('stores.order.index', $whereMonth) }}" class="overview-task-inner">
                                            <span class="overview-task-title">订单数</span>
                                    ...
                                    <li>
                                        <a href="{{ route('stores.order.index', $whereMonth+['pay_status' => \App\Order::PAY_STATUS_PAID]) }}" class="overview-task-inner">
                                            <span class="overview-task-title">已支付</span>
                    ...
                    <div class="col-xs-12 col-lg-3 overview-task overview-panel">
                        <div class="overview-panel-inner card">
                            <div class="overview-panel-title">总订单</div>
                            <div class="overview-panel-body">
                                <ul class="overview-task-list">
                                    <li>
                                        <a href="{{ route('stores.order.index') }}" class="overview-task-inner">
                                            <span class="overview-task-title">订单数</span>
                                    ...
                                    <li>
                                        <a href="{{ route('stores.order.index', ['pay_status' => \App\Order::PAY_STATUS_PAID]) }}" class="overview-task-inner">
                                            <span class="overview-task-title">已支付</span>
