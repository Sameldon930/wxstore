    ...
    <div class="box">
                    ...
                    <td>
                        @if($settleLog->status === \App\SettleLog::STATUS_WAITING)
                            <a class="pretty-btn pretty-btn-danger"
                               href="{{route('admin.tube_settle.settle',['id'=>$settleLog->id])}}"
                               onclick="return confirm('结算后不可修改，确认结算吗？')"
                            >
                                结算
                            </a>
                        @endif
                        <a href="{{route('admin.tube_settle.downloadBill',['id'=>$settleLog->id])}}" class="pretty-btn">
                            下载对账单
                        </a>
                    </td>
                </tr>
        ...
        <div class="box-body">
            ...
            <iframe frameborder="0" width="100%" height="600" scrolling="auto" id="sub-orders"
                    src="{{ route('admin.tube_settle.subOrders', ['settleLog' => $settleLog]) }}">
