            ...
            <form class="form form-inline box-body" method="post" id="form"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control " name="name" id="name" required
                           value="{{ old_or_new_field('name', $role) }}">
                </div>
                <br>

                <div class="form-group">
                    <label class="control-label" for="display">显示名称：</label>
                    <input class="form-control " name="display" id="display" required
                           value="{{ old_or_new_field('display', $role) }}">
                </div>
                <br>
                                ...
                                @foreach($routes as $route)
                                    <label class="pretty-checkbox">
                                        <input type="checkbox" name="permissions[]" data-group="{{$group}}"
                                               ...
                                               @if($permissions && in_array($route->action['as'], $permissions)) checked @endif
                                        >
